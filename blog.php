			...
			<?php 
				...
				<div class="col-md-8 top-post-left" data-aos="fade-left" data-aos-duration="1500">
					<div class="post post-thumb">
						<a class="post-img" href="http://localhost/infotech/blog-details.php/<?php echo $blogs_datalate['slug']; ?>"><img src="<?php echo str_replace('../','',$blogs_datalate['image']); ?>" alt="<?php echo str_replace('-',' ',$blogs_datalate['slug']); ?>"  title="<?php echo str_replace('-',' ',$blogs_datalate['slug']); ?>"  ></a>
						<div class="post-body">
							<div class="post-category">
								<a href="what-is-ui-ux-design.php"><?php echo $blog_catxx['cat']; ?></a>
							</div>
							<h1 class="post-title title-lg"><a href="http://localhost/infotech/blog-details.php/<?php echo $blogs_datalate['slug']; ?>"><?php echo $blogs_datalate['title']; ?></a></h1>
							<ul class="post-meta">
				...
				<?php foreach($blogs_datalate2 as $blogs){ 
				   ...
				   $blog_catx = $stmt_cat->fetch();
					?>
					<div class="post post-thumb">
						<a class="post-img" href="http://localhost/infotech/blog-details.php/<?php echo $blogs['slug']; ?>"><img src="<?php echo str_replace('../','',$blogs['image']); ?>" alt="<?php echo str_replace('-',' ',$blogs['slug']); ?>"  title="<?php echo str_replace('-',' ',$blogs['slug']); ?>" ></a>
						<div class="post-body">
							<div class="post-category">
								<a href="#"><?php echo $blog_catx['cat']; ?></a>
							</div>
							<h1 class="post-title"><a href="http://localhost/infotech/blog-details.php/<?php echo $blogs['slug']; ?>"><?php echo $blogs['title']; ?></a></h1>
							<ul class="post-meta">
				   ...
				   $blog_catx = $stmt_cat->fetch();
					...
					<div class="col-md-6">
						<div class="post" data-aos="fade-up" data-aos-duration="1500">
							<a class="post-img" href="http://localhost/infotech/blog/<?php echo $blogs['slug']; ?>"><img src="<?php echo str_replace('../','',$blogs['image']); ?>" alt="<?php echo str_replace('-',' ',$blogs['slug']); ?>"  title="<?php echo str_replace('-',' ',$blogs['slug']); ?>"  ></a>
							<div class="post-body">
								<div class="post-category">
									<a href="#"><?php echo $blog_catx['cat']; ?></a>
								</div>
								<h1 class="post-title"><a href="http://localhost/infotech/blog/<?php echo $blogs['slug']; ?>"><?php echo $blogs['title']; ?></a></h1>
								<ul class="post-meta">
									<li><a href="#"><?php echo $blogs['added_by']; ?></a></li>
									<li><?php $yrdata= strtotime($blogs['add_date']);
    											echo date('j-M-Y', $yrdata); ?> </li>
