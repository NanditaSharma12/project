...
<?php  
  ...
  'application/pdf'
	...
	elseif(empty($link)) {
	$error_name=  "<span class='error'>Please enter your portfolio link.</span>";
	}
	elseif (!preg_match("/^(?:(?:https?|ftp):\/\/)?(?:(?!(?:10|127)(?:\.\d{1,3}){3})(?!(?:169\.254|192\.168)(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)(?:\.(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)*(?:\.(?:[a-z\u00a1-\uffff]{2,})))(?::\d{2,5})?(?:\/\S*)?$/",$link)) {
	$error_link=  "<span class='error'>Please enter valid portfolio link.</span>";
	}
            ...
            <div class="row">
				...
				<div id="apply-form">
                   ...
                   <?php if(!empty($msg)){ ?> <p style="color:red;"> <?php echo $msg; ?></p> <?php }elseif(!empty($message)){?><p style="color:green;"> <?php echo $message; ?></p>  <?php }else{}?>
						...
						<div class="form-group">
							<h6>Phone Number</h6>
							<input type="number" class="form-control " id="career_phone" name="career_phone">
