...
$stmt = $conn->query("SELECT * FROM applied order by id desc ");
...
if(isset($_GET['id'])){ 
  ...
  header('location:https://masterinfotech.com/admin/job-query.php');
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Manage Applied Users</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Manage Applied Users
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   foreach ($data as $row) { ?>
                                ...
                                <tr>
                                        ...
                                        <td><a href="<?php echo $row['plink']; ?>" target="_blank">View Profile</a></td>
										<td><a href="<?php echo $row['cv']; ?>" target="_blank">View Resume</a></td>
                                        <td><a href="job-query.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?')">Delete<a>  </td>
