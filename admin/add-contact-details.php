 ...
 {  
    ...
    if(isset($_POST['update'])){
		...
		{  
          ...
          $data[] = array('icon' => $icon[$i], 'link'=> $link[$i]);
          ...
          $json_data = json_encode($data);
             ...
             $data = [
                 ...
                 'social_data' => $json_data,

                     ];

				$sql = "UPDATE contact_us_content SET  phone=:phone,email=:email,sms=:sms,address=:address,social_data=:social_data WHERE id=:id";

				$conn->prepare($sql)->execute($data);

		}			 

				 header("location:https://masterinfotech.com/admin/manage-contact-details.php");  
	...
	if(isset($_POST['save'])){
		...
		$sql = "INSERT INTO contact_us_content (phone,email,sms,address,social_data) VALUES (:phone,:email,:sms,:address,:social_data)";
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Add Home Choose Best Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="https://masterinfotech.com/admin/add-choose-best.php">Add Home Choose Best Content</a>
...
<?php 
	...
	if(isset($_GET['id'])){ 
		...
		$stmt = $conn->prepare("SELECT * FROM contact_us_content WHERE id=?");
...
?>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['phone'])) {echo $service['phone']; } else{} ?>" placeholder="company name" name="phone">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['email'])) {echo $service['email']; } else{} ?>" placeholder="company name" name="email">

								</div>

                                <div class="form-group">

									<label for="complaintinput1">WhatsApp/ SMS</label>

									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['sms'])) {echo $service['sms']; } else{} ?>" placeholder="company name" name="sms">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['address'])) {echo $service['address']; } else{} ?>" placeholder="company name" name="address">

								</div>

                                    <div id="appenddata" class="row">

										<?php $data = json_decode($service['social_data']);
										...
										for($i=0; $i< count($data); $i++){ ?>
											...
											<div class="form-group col-md-6 mb-2">
                                             ...
                                             <label for="complaintinput1">fa-icon-class</label>
                                  		     ...
                                  		     <input type="text" id="complaintinput1" class="form-control round"  placeholder="company name" name="icon[]" value="<?php echo $data[$i]->icon; ?>">

                                        		</div>	

                                        		<div class="form-group col-md-6 mb-2">

                                        		     <label for="complaintinput1">Social media link</label>

                                        		     <input type="text" id="complaintinput1" class="form-control round"  placeholder="company name" name="link[]" value="<?php echo $data[$i]->link; ?>">
                                    ...
                                    <button class="appendbtn btn btn-primary" type="button">Add More Social Media Links</button>
...
<?php }else{ ?>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['title'])) {echo $service['title']; } else{} ?>" placeholder="company name" name="phone">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['title'])) {echo $service['title']; } else{} ?>" placeholder="company name" name="email">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['title'])) {echo $service['title']; } else{} ?>" placeholder="company name" name="sms">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['title'])) {echo $service['title']; } else{} ?>" placeholder="company name" name="address">
                                    ...
                                    <div id="appenddata" class="row">
                                        ...
                                        <div class="form-group col-md-6 mb-2">
                                             ...
                                             <input type="text" id="complaintinput1" class="form-control round"  placeholder="company name" name="icon[]">
                                        ...
                                        <div class="form-group col-md-6 mb-2">
                                             ...
                                             <input type="text" id="complaintinput1" class="form-control round"  placeholder="company name" name="link[]">
...
<!-- // Basic form layout section end -->
    ...
    <footer class="footer footer-static footer-light navbar-border navbar-shadow">
      ...
      <div class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block">2019  &copy; Copyright <a class="text-bold-800 grey darken-2" href="https://masterinfotech.com/" target="_blank">masterinfotech.com</a></span>
...
$("#appenddata").append('<div class="form-group col-md-6 mb-2"><label for="complaintinput1">fa-icon-class</label> <input type="text" id="complaintinput1" class="form-control round" value="" placeholder="company name" name="icon[]"> </div><div class="form-group col-md-6 mb-2"> <label for="complaintinput1">Social media link</label> <input type="text" id="complaintinput1" class="form-control round" value="" placeholder="company name" name="link[]"> </div>');
