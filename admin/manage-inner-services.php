<?php  
 ...
 if(isset($_GET['servid'])){ 
  ...
  $stmt = $conn->query("SELECT * FROM inner_service_data where service_id ='$servid' order by id desc");
...
if(isset($_GET['id'])){ 
  ...
  $stmt = $conn->prepare("DELETE FROM service_data WHERE id=?");
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Services Inner Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/add-service-course.php?service_id=<?php echo $servid; ?>">Add Service Content</a>

                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/manage-services-inner.php">Back Service Content</a>

                  </li>

                  <li class="breadcrumb-item active">Manage Services Inner Content
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h4 class="card-title">Services Inner Content List</h4>
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php
                                ...
                                <tr>
                                        ...
                                        <td><?php if($row['image'] !=''){ ?><img src="<?php echo $row['image']; ?>" height="70px" width="50px"/> <?php }else{} ?></td>

                                 

                                        <td><a href="add-service-course.php?id=<?php echo $row['id']; ?>">Edit<a> / <a href="manage-inner-services.php?id=<?php echo $row['id']; ?>">Delete<a> </td>
