...
$stmt = $conn->query("SELECT * FROM jobs order by id desc ");
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Manage Job Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/add-quality.php">Add Job Content</a>
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   foreach ($data as $row) { ?>
                                ...
                                <tr>
                                        ...
                                        <td><a href="add-jobs.php?id=<?php echo $row['id']; ?>">Edit<a>  / <a href="manage-jobs.php?id=<?php echo $row['id']; ?>">Delete<a>  </td>
