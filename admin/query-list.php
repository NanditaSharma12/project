...
$stmt = $conn->query("SELECT * FROM contact_user order by id desc");
...
if(isset($_GET['id'])){ 
  ...
  $stmt = $conn->prepare("DELETE FROM contact_user WHERE id=?");

  $stmt->execute([$id]); 

  header('location:https://masterinfotech.com/admin/query-list.php');
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Contact us Queries</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Manage Contact us Page Queries
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h4 class="card-title">Contact us Page Queries</h4>
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   foreach ($data as $row) { ?>
                                ...
                                <tr>
                                        ...
                                        <td> <a href="query-list.php?id=<?php echo $row['id']; ?>"> Delete</a> </td>
