<?php  
 ...
 {  
    ...
    if(isset($_POST['update'])){
		...
		{  
            ...
            $data = [
				...
				$sql = "UPDATE blogs_cat SET  cat=:cat WHERE id=:id";

				$conn->prepare($sql)->execute($data);

		}			 

				 header("location:https://masterinfotech.com/admin/manage-blog-cat.php");  
	...
	if(isset($_POST['save'])){
		...
		$sql = "INSERT INTO blogs_cat (cat) VALUES (:cat)";
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Add Blog Categories</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="https://masterinfotech.com/admin/add-choose-best.php">Add Blog Categories</a>
...
<?php 
	...
	if(isset($_GET['id'])){ 
		...
		$stmt = $conn->prepare("SELECT * FROM blogs_cat WHERE id=?");
...
?>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
									...
									<label for="complaintinput1">Blog Category</label>

									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['cat'])) {echo $service['cat']; } else{} ?>" placeholder="company name" name="cat">
...
<?php }else{ ?>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="company name" name="cat">
