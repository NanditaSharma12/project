<?php  
 ...
 {  
			...
			if(!empty($image)){
					...
					if($_FILES['image']['tmp_name'] !=""){
						...
						if($isUploaded){
							...
							$sql = "UPDATE home_slider SET title=:title, image=:image, description=:description WHERE id=:id";
				...
				$sql = "UPDATE home_slider SET title=:title, description=:description WHERE id=:id";

				$conn->prepare($sql)->execute($data);

		}			 

				 header("location:https://masterinfotech.com/admin/manage-sliders.php");  
	...
	if(isset($_POST['save'])){
		...
		$sql = "INSERT INTO home_slider (title, image, description) VALUES (:title, :image, :description)";
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="https://masterinfotech.com/admin/add-sliders.php">Add Sliders</a>
	...
	<form class="form" method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-body">
								...
								<div class="form-group">
									...
									<label for="complaintinput1">Home Slider Title</label>

									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($title['title'])) {echo $title['title']; } else{} ?>" placeholder="company name" name="title">
								...
								<div class="form-group">
									...
									<label for="complaintinput2">Home Slider Image</label>

									<input type="file" id="complaintinput2" class="form-control round" placeholder="Slider image" name="image">
								...
								<div class="form-group">
									...
									<label for="complaintinput5">Home Slider Description</label>

									<textarea id="complaintinput5" rows="5" class="form-control round" name="description" placeholder="description"><?php if(!empty($title['description'])) {echo $title['description']; } else{} ?></textarea>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-body">
								...
								<div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" placeholder="company name" name="title">
								...
								<div class="form-group">
									...
									<input type="file" id="complaintinput2" class="form-control round" placeholder="title image" name="image">
								...
								<div class="form-group">
									...
									<label for="complaintinput5">Home Slider Detail</label>

									<textarea id="complaintinput5" rows="5" class="form-control round" name="description" placeholder="description"></textarea>
