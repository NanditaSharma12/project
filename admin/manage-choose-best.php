...
$stmt = $conn->query("SELECT * FROM home_choose_best order by id desc limit 1");
...
if(isset($_GET['id'])){ 
  ...
  $stmt = $conn->prepare("DELETE FROM home_choose_best WHERE id=?");

  $stmt->execute([$id]); 

  header('location:https://masterinfotech.com/admin/manage-choose-best.php');
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Home Choose The Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/add-choose-best.php">Add Home Choose The Content</a>

                  </li>

                  <li class="breadcrumb-item active">Manage Choose The Content
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h4 class="card-title">Home Choose The Content</h4>
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   foreach ($data as $row) { ?>
                                ...
                                <tr>
                                        ...
                                        <td><a href="add-choose-best.php?id=<?php echo $row['id']; ?>">Edit<a>  </td>
