...
$stmt = $conn->query("SELECT * FROM home_slider order by id desc");
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/add-Sliders.php">Add Sliders</a>

                  </li>

                  <li class="breadcrumb-item active">Manage Sliders
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   foreach ($data as $row) { ?>
                                ...
                                <tr>
                                        ...
                                        <td><img src="<?php echo $row['image']; ?>" height="70px" width="50px"/></td>

                                        <td><?php echo $row['description']; ?></td>

                                        <td><a href="add-sliders.php?id=<?php echo $row['id']; ?>">Edit<a> / <a href="manage-sliders.php?id=<?php echo $row['id']; ?>">Delete<a> </td>
