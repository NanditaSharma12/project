...
$stmt = $conn->query("SELECT * FROM service_data order by id desc");
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Service Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/add-services-inner.php">Add More Service Content</a>

                  </li>

                  <li class="breadcrumb-item active">Manage Service Content
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php
                                ...
                                <tr>
                                        ...
                                        <td><a href="add-services-inner.php?id=<?php echo $row['id']; ?>">Edit<a> / <a href="manage-services-inner.php?id=<?php echo $row['id']; ?>">Delete<a> </td>

                                        <td><a href="manage-inner-services.php?servid=<?php echo $row['service_id']; ?>">Manage Inner Services Content<a></td>
