<?php  
 ...
 {  
    ...
    if(isset($_POST['update'])){
        ...
        $imagex=$_FILES['pc_image']['name']; 
            ...
            if(!empty($imagex))    {
                ...
                $isUploadedx=move_uploaded_file($_FILES["pc_image"]["tmp_name"],$uploadPathx);
					...
					$data = [
					   ...
					   $sql = "UPDATE inner_service_data SET  title=:title,description=:description,image=:image WHERE id=:id";
					...
					$data = [
					   ...
					   $sql = "UPDATE inner_service_data SET  title=:title,description=:description WHERE id=:id";
        ...
        header("location:https://masterinfotech.com/admin/manage-inner-services.php?servid=$service_id");   
    ...
    $title = $_POST['title'];
		...
		$pc_imagex=$_FILES['pc_image']['name'];

	 	$imagepc_image=explode('.',$pc_imagex); //first index is file name and second index file type

		$rand17=rand(10000,99999);

		$newpc_image=$imagepc_image[0].$rand17.'.'.$imagepc_image[1];

	    $uploadPathpc_image="../uploads/".$newpc_image ;

		$isUploadpc_image=move_uploaded_file($_FILES["pc_image"]["tmp_name"],$uploadPathpc_image);

			if($isUploadpc_image){

				$pc_image = $uploadPathpc_image;

			}

			

 	 $sql = "INSERT INTO `inner_service_data`(`service_id`, `title`,`image`, `description`) VALUES ('$service_id','$title','$pc_image','$pc_content')";
    ...
    header("location:https://masterinfotech.com/admin/add-service-course.php?service_id=$service_id"); 
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Add Service Inner Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="https://masterinfotech.com/admin/add-service-course.php">Add Service Inner Content</a>
...
<?php 
	...
	if(isset($_GET['id'])){ 
		...
		$stmt = $conn->prepare("SELECT * FROM inner_service_data WHERE id=?");
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-2">
                                          ...
                                          <label for="complaintinput1">Ttitle</label>

                                      

                                           <input type="text" name="title"  class="form-control round" value="<?php echo $service['title']; ?>" placeholder="company name" >
                                 ...
                                 <div class="form-group col-md-6 mb-2">
                                             ...
                                             <input type="file" id="complaintinput1" class="form-control round"  placeholder="company name" name="pc_image">
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="form-group col-md-6 mb-2">
								    	...
								    	<textarea id="complaintinput5" rows="5" class="form-control round" name="content"  placeholder="details"><?php echo $service['description']; ?></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-2">
                                          ...
                                          <label for="complaintinput1">Ttitle</label>
                                           ...
                                           <input type="text" name="title"  class="form-control round"  placeholder="company name" >
                                 ...
                                 <div class="form-group col-md-6 mb-2">
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="form-group col-md-6 mb-2">
								    	...
								    	<textarea id="complaintinput5" rows="5" class="form-control round" name="content" placeholder="details"></textarea>
