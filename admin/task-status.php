...
$stmt = $conn->query("SELECT * FROM task where id ='$id'");
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Task Info</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Task Info
                    ...
                    <div class="card-body card-dashboard">
                         ...
                         <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   
							  $rid = $data['assign_to'];
							  $stmt1 = $conn->query("SELECT * FROM admin where id =$rid");
							  ...
							  ?> 
                                ...
                                <tr>
                                        ...
                                        <td><?php if($data['status'] == 1) {echo"Working";} elseif($data['status'] == 2){echo"Pending";}elseif($data['status'] == 3){echo"Done";}elseif($data['status'] == 4){echo"Approved";} ?></td>
