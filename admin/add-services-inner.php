<?php  
 ...
 {  
    ...
    if(isset($_POST['update'])){
		...
		{  
		   ...
		   if(!empty($imagex))    {
			   ...
			   $isUploadedx=move_uploaded_file($_FILES["main_image"]["tmp_name"],$uploadPathx);
				   ...
				   $data = [
					  ...
					  $sql = "UPDATE service_data SET  service_id=:service_id,description=:description,image=:image WHERE id=:id";
				  ...
				  $data = [
					  ...
					  $sql = "UPDATE service_data SET  service_id=:service_id,description=:description WHERE id=:id";
        ...
        header("location:https://masterinfotech.com/admin/manage-services-inner.php");   
	...
	if(isset($_POST['save'])){
		...
		$sql = "INSERT INTO `service_data`(`service_id`,`image`, `description`) VALUES (:service_id, :image, :description1)";
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Add Services Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="https://masterinfotech.com/admin/add-services-inner.php">Add Services Content</a>
...
<?php 
	...
	if(isset($_GET['id'])){ 
		...
		$stmt = $conn->prepare("SELECT * FROM service_data WHERE id=?");
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
									...
									<div class="form-group col-md-6 mb-2">
                                          ...
                                          <label for="complaintinput1">Select Service Category</label>

									     <select id="projectinput7" name="service_id" class="form-control">

			                                <option value="0" selected="" disabled="">Select  Service</option>

                                            <?php   foreach ($data as $row) { ?>

			                                <option value="<?php echo $row['id']; ?>" <?php if($service['service_id'] == $row['id']){ echo'selected'; }else{} ?>><?php echo $row['title']; ?></option>
								...
								<div class="form-group">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="form-group col-md-12 mb-2">
								    	...
								    	<textarea  id="ckeditextaerea" cols="30" rows="15" rows="5" class="ckeditor-color" name="description1" placeholder="details">    <?php echo $service['description']; ?></textarea>
                                 ...
                                 <div class="form-group col-md-6 mb-2">
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="form-group col-md-12 mb-2">
								    	...
								    	<textarea  id="ckeditextaerea" cols="30" rows="15" rows="5" class="ckeditor-color" name="description1" placeholder="details"></textarea>
