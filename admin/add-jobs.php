<?php  
 ...
 {  
		...
		{  
			...
			$description = $_POST['description'];
			 ...
			 $data = [
				...
				$sql = "UPDATE contact_us_content SET  title=:title,area=:area,experience=:experience,description=:description WHERE id=:id";

				$conn->prepare($sql)->execute($data);

		}			 

				 header("location:https://masterinfotech.com/admin/manage-jobs.php");  
	...
	if(isset($_POST['save'])){
		...
		$sql = "INSERT INTO jobs (title,area,experience,description) VALUES (:title,:area,:experience,:description)";
...
?>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
									...
									<label for="complaintinput1">Job Title</label>

									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['title'])) {echo $service['title']; } else{} ?>" placeholder="company name" name="title">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['area'])) {echo $service['area']; } else{} ?>" placeholder="company name" name="area">

								</div>

                                <div class="form-group">

									<label for="complaintinput1">Job Experience</label>

									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['experience'])) {echo $service['experience']; } else{} ?>" placeholder="company name" name="experience">
...
<?php }else{ ?>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="company name" name="title">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="company name" name="area">

								</div>

                                <div class="form-group">

									<label for="complaintinput1">Experience</label>

									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="company name" name="experience">
