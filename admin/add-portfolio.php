<?php  
 ...
 {  
    ...
    if(isset($_POST['update'])){
            ...
            if(!empty($imagex))    {
                ...
                $isUploadedx=move_uploaded_file($_FILES["image"]["tmp_name"],$uploadPathx);
					...
					$data = [
					   ...
					   $sql = "UPDATE portfolio SET link=:link,title=:title,image=:image,description=:description WHERE id=:id";
					...
					$data = [
					   ...
					   $sql = "UPDATE portfolio SET link=:link,title=:title,description=:description WHERE id=:id";
        ...
        header("location:https://masterinfotech.com/admin/manage-portfolio.php");   
	...
	if(isset($_POST['save'])){
		...
		$sql = "INSERT INTO portfolio (link,title,image,description) VALUES (:link,:title,:image,:description)";
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Add Portfolio Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="https://masterinfotech.com/admin/add-portfolio.php">Add Portfolio Content</a>
...
<?php 
	...
	if(isset($_GET['id'])){ 
		...
		$stmt = $conn->prepare("SELECT * FROM portfolio Content_data WHERE id=?");
...
?>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
									...
									<label for="complaintinput1">Portfolio Link</label>

									<input type="text" id="complaintinput1" class="form-control round"  placeholder="company name" name="link" value="<?php echo $service['link']; ?>">

								</div>

                                <div class="form-group">

									<label for="complaintinput1">Portfolio Title</label>
								...
								<div class="form-group">
									...
									<label for="complaintinput1">Portfolio Main Image</label>
                                ...
                                <div class="form-group">
									...
									<label for="complaintinput1">Portfolio Description</label>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-body">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="company name" name="link">
