      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Manage Portfolio Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/add-portfolio.php">Add Portfolio Content</a>

                  </li>

                  <li class="breadcrumb-item active">Manage Portfolio Content
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   foreach ($data as $row) { 
                                ...
                                <tr>
                                        ...
                                        <td><a href="add-portfolio.php?id=<?php echo $row['id']; ?>">Edit<a>  / <a href="manage-portfolio.php?id=<?php echo $row['id']; ?>">Delete<a>  </td>
