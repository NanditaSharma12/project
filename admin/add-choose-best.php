 ...
 {  
    ...
    if(isset($_POST['update'])){
		...
		{   
				...
				$sql = "UPDATE home_choose_best SET  description=:description WHERE id=:id";
	...
	if(isset($_POST['save'])){
		...
		$sql = "INSERT INTO home_choose_best (description) VALUES (:description)";
...
<?php 
	...
	if(isset($_GET['id'])){ 
		...
		$stmt = $conn->prepare("SELECT * FROM home_choose_best WHERE id=?");
	...
	<form class="form" method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-body">
								...
								<div class="form-group">
									...
									<label for="complaintinput5">Home Choose Best Content</label>
