            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/add-services.php">Add Services</a>

                  </li>

                  <li class="breadcrumb-item active">Manage Services
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   foreach ($data as $row) { ?>
                                ...
                                <tr>
                                        ...
                                        <td><?php if($row['icon'] !=''){ ?><img src="<?php echo $row['icon']; ?>" height="70px" width="50px"/> <?php }else{}?></td>

                                        <td><?php echo $row['description']; ?></td>

                                        <td><a href="add-services.php?id=<?php echo $row['id']; ?>">Edit<a> / <a href="manage-services.php?id=<?php echo $row['id']; ?>">Delete<a> </td>
