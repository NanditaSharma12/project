 ...
 {  
    ...
    if(isset($_POST['update'])){
		...
		{   
				...
				$sql = "UPDATE home_developing_tech SET  description=:description WHERE id=:id";

				$conn->prepare($sql)->execute($data);

		}			 

				 header("location:https://masterinfotech.com/admin/manage-developing.php");  
	...
	if(isset($_POST['save'])){
		...
		$sql = "INSERT INTO home_developing_tech (description) VALUES (:description)";
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Home Developing Technologies and Trust Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="https://masterinfotech.com/admin/add-developing.php">Add Home Developing Technologies and Trust Content</a>
...
<?php 
	...
	if(isset($_GET['id'])){ 
		...
		$stmt = $conn->prepare("SELECT * FROM home_developing_tech WHERE id=?");
	...
	<form class="form" method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-body">
								...
								<div class="form-group">
									...
									<label for="complaintinput5">Home Developing Technologies and Trust</label>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-body">
								...
								<div class="form-group">
									...
									<label for="complaintinput5">Home Developing Technologies and Trust Content</label>
