...
$stmt = $conn->query("SELECT * FROM get_quote order by id desc");
...
if(isset($_GET['id'])){ 
    ...
    $dlt = $conn->prepare("DELETE FROM get_quote WHERE id=?");
  
    $dlt->execute([$id]); 
  
    header('location:'.$url.'enquiries.php');
}
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        ...
                        <div class="breadcrumb-wrapper mr-1">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Enquiry Page
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($data as $row) { ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <a href="enquiries.php?id=<?php echo $row['id']; ?>"><button class="btn btn-sm btn-outline-primary round" type="button">Delete</button></a> </td>
