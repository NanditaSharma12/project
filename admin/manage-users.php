...
if(isset($_GET['id'])){ 
  ...
  $stmt = $conn->prepare("DELETE FROM admin where role_id !=0 and id=?");
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/add-sections.php">Add Users</a>
                    ...
                    <div class="card-body card-dashboard">
                         ...
                         <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
							  ...
							  $rid = $row['role_id'];
							  $stmt1 = $conn->query("SELECT * FROM user_roles where id =$rid");
							  ...
							  ?>
                                ...
                                <tr>
                                        ...
                                        <td><a href="add-users.php?id=<?php echo $row['id']; ?>">Edit<a>  / <a href="manage-users.php?id=<?php echo $row['id']; ?>">Delete<a>  </td>
