...
$stmt = $conn->query("SELECT * FROM home_developing_tech order by id desc limit 1");
...
if(isset($_GET['id'])){ 
  ...
  $stmt = $conn->prepare("DELETE FROM home_developing_tech WHERE id=?");
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/add-quality.php">Add Quality Assurance Content</a>

                  </li>

                  <li class="breadcrumb-item active">Manage Quality Assurance Content
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h4 class="card-title">Home Developing Technologies and Trust Content</h4>
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>Quality Assurance Content</th>
                              ...
                              <?php   foreach ($data as $row) { ?>
                                ...
                                <tr>
                                        ...
                                        <td><a href="add-developing.php?id=<?php echo $row['id']; ?>">Edit<a>  </td>
