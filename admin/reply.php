    ...
    if(isset($_POST['update']))
	{
          ...
          $data = [
				...
				$conn->prepare($sql)->execute($data);
				 ...
				 header("location:".$url.'comment.php');  
...
?>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
							...
							<input type="hidden" id="id" name="id" class="form-control round" value="<?php if(!empty($revert['id'])) {echo $revert['id']; } else{} ?>" placeholder="">

								</div>

                            <div class="form-group">

									<label for="">Reply to the comment</label><br>

									<textarea type="text" name="reply" id="reply" ><?php if(!empty($revert['reply'])) {echo $revert['reply']; } else{} ?>
									</textarea>
							...
							<div class="form-actions">
								...
								<!--<a href="<?php echo $url.'comment.php'?>"><button type="submit" class="btn btn-danger mr-1">
