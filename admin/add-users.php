<?php  
 ...
 {  
    ...
    if(isset($_POST['update'])){
		  	 ...
		  	 $role_id = $_POST['role_id'];
				...
				$data = [
					...
					'role_id' => $role_id,
					   ...
					   $sql = "UPDATE admin SET  name=:name,email=:email,phone=:phone,password=:password,role_id=:role_id WHERE id=:id";
        ...
        header("location:https://masterinfotech.com/admin/manage-users.php");   
	...
	$sql = "INSERT INTO admin (name,email,phone,password,role_id) VALUES (:name,:email,:phone,:password,:role_id)";
 ...
 $stmt = $conn->query("SELECT * FROM user_roles order by id desc ");
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Add Sections</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="https://masterinfotech.com/admin/add-sections.php">Add Sections</a>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-body">
                             ...
                             <div class="form-group ">
                                          ...
                                          <label for="complaintinput1">Select User Role</label>

									     <select id="projectinput7" name="role_id" class="form-control">

			                                <option value="0" selected="" disabled="">Select User Role</option>

                                            <?php   foreach ($data as $row) { ?>

			                                <option value="<?php echo $row['id']; ?>" <?php if($service['role_id'] == $row['id']){ echo'selected'; }else{} ?> ><?php echo $row['role']; ?></option>
                                ...
                                <div class="form-group">
									...
									<label for="complaintinput1">User name</label>

									<input type="text" id="complaintinput1" class="form-control round" value="<?php echo $service['name']; ?>" placeholder="User name" name="name">

								</div>

                                <div class="form-group">

									<label for="complaintinput1">User email</label>

									<input type="text" id="complaintinput1" class="form-control round" value="<?php echo $service['email']; ?>" placeholder="User email" name="email">

								</div>
                                <div class="form-group">

									<label for="complaintinput1">User phone</label>

									<input type="text" id="complaintinput1" class="form-control round" value="<?php echo $service['phone']; ?>" placeholder="User phone" name="phone">
                                ...
                                <div class="form-group">
									...
									<label for="complaintinput1">User password</label>

									<input type="text" id="complaintinput1" class="form-control round" value="<?php echo $service['password']; ?>" placeholder="User Password" name="pwd">
							...
							<div class="form-body">
							 <div class="form-group ">
									     ...
									     <select id="projectinput7" name="role_id" class="form-control">
			                                ...
			                                <option value="<?php echo $row['id']; ?>" <?php if($service['id'] == $row['id']){ echo'selected'; }else{} ?> ><?php echo $row['role']; ?></option>
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="User name" name="name">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="User email" name="email">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="User phone" name="phone">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="User Password" name="pwd">
...
<!-- // Basic form layout section end -->
 ...
 CKEDITOR.replace( 'ckeditextaerea' );

 CKEDITOR.inline( 'ckeditextaerea' );
