...
if(isset($_GET['id'])){ 
  ...
  $stmt = $conn->prepare("DELETE FROM blogs_cat WHERE id=?");
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Manage Blog Categories</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/add-blog-cat.php">Add Blog Categories</a>
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   foreach ($data as $row) { ?>
                                ...
                                <tr>
                                        ...
                                        <td><a href="add-blog-cat.php?id=<?php echo $row['id']; ?>">Edit<a>  / <a href="manage-blog-cat.php?id=<?php echo $row['id']; ?>">Delete<a>  </td>
