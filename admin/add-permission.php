<?php  
 ...
 {  
		  	 ...
		  	 $section = implode(',',$_POST['section']);
				$data = [
					...
					'id'=>$id,
					   ...
					   $sql = "UPDATE  permission SET  user_id=:user_id,section=:section WHERE id=:id";
	...
	$sql = "INSERT INTO  permission (user_id,section) VALUES (:user_id,:section)";
 ...
 $stmt = $conn->query("SELECT * FROM admin where role_id !=0 order by id desc ");
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Add permissions</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="https://masterinfotech.com/admin/add-permission.php">Add permissions</a>
...
<?php 
	...
	if(isset($_GET['id'])){ 
		...
		$stmt = $conn->prepare("SELECT * FROM permission WHERE id=?");
...
?>
 ...
 <div class="form-group ">
                                          ...
                                          <label for="complaintinput1">Select Users</label>

									     <select id="projectinput7" name="user_id" class="form-control">

			                                <option value="0" selected="" disabled="">Select Users</option>

                                            <?php   foreach ($data as $row) { ?>

			                                <option value="<?php echo $row['id']; ?>" <?php if($service['user_id'] == $row['id']){ echo'selected'; }else{} ?> ><?php echo $row['name']; ?></option>
                             ...
                             <div class="form-group">
											...
											<?php  $sql = $conn->prepare("select * from section"); 
													$sql->execute();
													$section = $sql->fetchAll();
													$i=1;
													$ss = explode(',',$service['section']);
													
													foreach($section as $roles){
														
											?>
                                                <div class="d-inline-block custom-control custom-checkbox">
                                            <input type="checkbox" name="section[]"  <?php if(in_array($roles['id'],$ss)){ echo'checked'; }else{} ?> class="custom-control-input" value="<?php echo $roles['id']; ?>" id="staffing<?php echo $i; ?>">
                                                    &nbsp;&nbsp;&nbsp;<label class="custom-control-label" for="staffing<?php echo $i; ?>"><?php echo $roles['name']; ?></label>
                                                </div>
														<?php   $i++; } ?>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-body">
                             ...
                             <div class="form-group">
											...
											?>
                                                <div class="d-inline-block custom-control custom-checkbox">
                                                    <input type="checkbox" name="section[]" class="custom-control-input" value="<?php echo $roles['id']; ?>" id="staffing<?php echo $i; ?>">
                                                    &nbsp;&nbsp;&nbsp;<label class="custom-control-label" for="staffing<?php echo $i; ?>"><?php echo $roles['name']; ?></label>
                                                </div>
														<?php   $i++; } ?>
