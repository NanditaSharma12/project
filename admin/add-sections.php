<?php  
 ...
 {  
    ...
    if(isset($_POST['update'])){
        ...
        header("location:https://masterinfotech.com/admin/manage-sections.php");   
 ...
 $stmt = $conn->query("SELECT * FROM section order by id desc ");
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 mb-2">
                                             ...
                                             <label for="complaintinput1">Section Name</label>

                                             <input type="text" id="complaintinput1" class="form-control round"  placeholder="section name" name="name" value="<?php echo $service['name']; ?>">
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-body">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="Section name" name="name">
