      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Manage Who We Are Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Manage  Who We Are  Content
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   foreach ($data as $row) { ?>
                                ...
                                <tr>
                                        ...
                                        <td><img src="<?php echo $row['image1']; ?>" height="70px" width="50px"/></td>

                                        <td><?php echo $row['content1']; ?></td>

                                        <td><img src="<?php echo $row['image2']; ?>" height="70px" width="50px"/></td>

                                        <td><?php echo $row['content1']; ?></td>

                                        <td><a href="add-who-we-are.php?id=<?php echo $row['id']; ?>">Edit<a>  / <a href="manage-who-we-are.php?id=<?php echo $row['id']; ?>">Delete<a>  </td>
