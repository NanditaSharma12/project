...
$stmt = $conn->query("SELECT * FROM home_quality_content order by id desc limit 1");
...
if(isset($_GET['id'])){ 
  ...
  $stmt = $conn->prepare("DELETE FROM home_quality_content WHERE id=?");
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Home Quality Assurance Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/add-quality.php">Add Home Quality Assurance Content</a>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h4 class="card-title">Home Quality Assurance Content</h4>
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   foreach ($data as $row) { ?>
                                ...
                                <tr>
                                        ...
                                        <td><a href="add-quality.php?id=<?php echo $row['id']; ?>">Edit<a>  </td>
