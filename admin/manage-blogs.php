...
$stmt = $conn->query("SELECT * FROM blogs_data order by id desc ");
...
if(isset($_GET['id'])){ 
  ...
  $stmt = $conn->prepare("DELETE FROM blogs_data WHERE id=?");
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Manage Blogs Content</h3>
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="https://masterinfotech.com/admin/add-blogs.php">Add Blogs Content</a>

                  </li>

                  <li class="breadcrumb-item active">Manage Job Content
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h4 class="card-title">Job Content</h4>
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   foreach ($data as $row) { 
                                ...
                                <tr>
                                        ...
                                        <td><?php echo $service['cat']; ?></td>

                                        <td><?php echo $row['title']; ?></td>

                                        <td><?php echo $row['added_by']; ?></td>

                                        <td><a href="add-blogs.php?id=<?php echo $row['id']; ?>">Edit<a>  / <a href="manage-blogs.php?id=<?php echo $row['id']; ?>">Delete<a>  </td>
