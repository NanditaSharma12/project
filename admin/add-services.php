<?php  
 ...
 {  
    ...
    if(isset($_POST['update'])){
		if(empty($_POST["service"]) || empty($_POST["details"]))  
		{  
		...
		if($_FILES['icon']['tmp_name'] !=""){
						$isUploaded=move_uploaded_file($_FILES["icon"]["tmp_name"],$uploadPath);
			if($isUploaded){
				$icon = $uploadPath;
			}
				...
				$sql = "UPDATE categories SET title=:title, icon=:icon, description=:description WHERE id=:id";
				...
				$conn->prepare($sql)->execute($data);
				 ...
				 header("location:https://masterinfotech.com/admin/manage-services.php");  
		}
	...
	if(isset($_POST['save'])){
		...
		{  
		   ...
		   if(!empty($_FILES['icon']['name'])){
			...
			$sql = "INSERT INTO categories (title, icon, description) VALUES (:title, :icon, :description)";
		   }else{
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Add Services</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="https://masterinfotech.com/admin/add-services.php">Add Services</a>
                  </li>
                </ol>
              </div>
            </div>
	...
	<form class="form" method="post" action="" enctype="multipart/form-data">
							<div class="form-body">
								...
								<div class="form-group">
									<label for="complaintinput1">Service Name</label>
									<input type="text" id="complaintinput1" class="form-control round" value="<?php if(!empty($service['title'])) {echo $service['title']; } else{} ?>" placeholder="company name" name="service">
								</div>

								<div class="form-group">
									<label for="complaintinput2">Service Icon</label>
									<input type="file" id="complaintinput2" class="form-control round" placeholder="Service Icon" name="icon">
									<img src="<?php echo $service['icon']; ?>" height="70px" width="50px"/>
								</div>

								

								<div class="form-group">
									<label for="complaintinput5">Service Home Detail</label>
...
<?php }else{ ?>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
							<div class="form-body">
								...
								<div class="form-group">
									<label for="complaintinput1">Service Name</label>
									<input type="text" id="complaintinput1" class="form-control round" placeholder="company name" name="service">
								</div>
