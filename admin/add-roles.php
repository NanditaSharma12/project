<?php  
 ...
 {  
    ...
    if(isset($_POST['update'])){
		...
		{  
			...
			$role = $_POST['role'];
					$data = [
					   ...
					   $sql = "UPDATE user_roles SET  role=:role WHERE id=:id";
        ...
        header("location:https://masterinfotech.com/admin/manage-roles.php");   
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="https://masterinfotech.com/admin/add-roles.php">Add role</a>
...
<?php 
	...
	if(isset($_GET['id'])){ 
		...
		$stmt = $conn->prepare("SELECT * FROM user_roles WHERE id=?");
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 mb-2">
                                             ...
                                             <label for="complaintinput1">Role Name</label>

                                   <input type="text" id="complaintinput1" class="form-control round"  placeholder="section name" name="role" value="<?php echo $service['role']; ?>">
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-body">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="Role name" name="role">
