      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            <h3 class="content-header-title">Add Blogs</h3>
...
<div class="form-group">
									...
									<label for="complaintinput1">Blog Title Slug</label>

									<input type="text" id="complaintinput1" class="form-control round"  placeholder="company name" name="slug" value="<?php echo $service['slug']; ?>">
 ...
 <div class="form-group">
									...
									<label for="complaintinput1">Meta Description</label>
								...
								<?php echo base64_decode($service['meta_desc']); ?>
                                 ...
                                 <div class="form-group">
									...
									<label for="complaintinput1">Meta Title</label>

                                    <textarea name="meta_title"  cols="50" rows="3" class="form-control round">

								<?php echo $service['meta_title']; ?>
	...
	<form class="form"  method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-body">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="company name" name="added_by">
...
<div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" value="" placeholder="company name" name="slug">
