...
$stmt = $conn->query("SELECT * FROM comment order by id desc");
...
// $stmtsidebar = $conn1->query("SELECT id FROM comment where name='$name'"); 
            ...
            <div class="breadcrumbs-top float-md-right">
              ...
              <div class="breadcrumb-wrapper mr-1">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Manage Comment Page
                         ...
                         <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <?php   foreach ($data as $row) { 
							    ...
							    $tt = $row['blog_id'];
								$title = $conn->query("SELECT title FROM blogs_data where id='$tt'"); 
								$datatitle = $title->fetch();
							    $titl = $datatitle['title'];	
								?>
                                ...
                                <tr>
                                        ...
                                        <td> <a href="reply.php?id=<?php echo $row['id']; ?>"><button class="btn btn-sm btn-outline-primary round" type="button">Reply</button></a> </td>
